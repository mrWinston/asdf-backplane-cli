...
# NOTE: You might want to remove this if backplane-cli is not hosted on GitHub releases.
...
list_all_versions() {
  ...
  # Change this function if backplane-cli has other means of determining installable versions.
  list_github_tags
}
...
install_version() {
  ...
  (
    ...
    # TODO: Assert backplane-cli executable exists.
    local tool_cmd
